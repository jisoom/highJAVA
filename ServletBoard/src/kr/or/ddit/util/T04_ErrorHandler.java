...
//			req.setAttribute("javax.servlet.error.exception", "알 수 없는 예외"); // 저장(타입상관없이)
		...
		String requestUri = (String)
			req.getAttribute("javax.servlet.error.servlet_uri");
		
		if(requestUri == null) {
			requestUri = "알 수 없는 URI";
		}
		// 위의 정보를 request 객체에 넣어줌
		...
		if(throwable == null && statusCode == null) {
			...
			out.println("예외 메세지 : " + throwable.getMessage() + "<br><br>");
