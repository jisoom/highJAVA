...
public class T05_SetTest {
	...
	public static void main(String[] args) {
		...
		boolean isAdd = hs1.add("FF"); //add는 true나 false를 반환함
...
//		System.out.println("Clear 후 Set 데이터 : " + hs1);
		...
		//불러올 수 없다. 그래서 불러오기 위해 Iterator객체를 사용한다.
		...
		while(intRnd.size() < 5) { // Set의 데이터가 5개가 될 때 까지 반복한다.
		...
		List<Integer> intRndList = new ArrayList<Integer>(intRnd); //new ArrayList<>(intRnd)랑 동일
