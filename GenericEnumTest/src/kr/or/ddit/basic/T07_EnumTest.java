 ...
 */
	...
	public enum City {서울 , 부산, 대구, 광주, 대전}; //City 타입의 enum 상수
//	public enum City2 {서울 , 부산, 대구, 광주, 대전};
	...
	public enum Season {
		...
		//생성자 만들기(열거형의 생성자는 제어자가 묵시적으로 'private'이다.) (클래스처럼 enum도 생성자를 만들어줌) //외부에서 마음대로 상수를 만들지 못하게 하려고 private으로 함
		...
		public static void main(String[] args) {
			...
			//열거형 객체변수에 값 저장하기
			myCity2 = City.서울; //City 타입의 enum 상수 객체를 넣음
			myCity1 = City.valueOf("서울"); //City enum에서 '서울'데이터 가져오기
			
			System.out.println("myCity1 : " + myCity1.name());
			System.out.println("myCity1의 ordinal : " + myCity1.ordinal());  //서울은 City enum에서 0번째임
			System.out.println();
